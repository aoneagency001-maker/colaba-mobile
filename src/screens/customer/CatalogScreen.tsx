...
// Фото подкатегорий (с stalfed.kz, сохранены на нашем сервере)
const SUBCAT_IMAGES: Record<string, string> = {
  ...
  'Лист холоднокатаный': `${IMG_BASE}/cat_list_hk2.png`,
  'Лист рифлёный': `${IMG_BASE}/cat_list_rifl_real.png`,
  'Лист оцинкованный': `${IMG_BASE}/cat_list_ocink_real.jpg`,
  'Профнастил': `${IMG_BASE}/cat_profnastil.png`,
  'Лист ПВЛ': `${IMG_BASE}/cat_list_pvl2.png`,
  'Лист нержавеющий': `${IMG_BASE}/cat_nerzh_list2.png`,
  'Труба профильная': `${IMG_BASE}/cat_truba_prof2.jpg`,
  'Труба ВГП': `${IMG_BASE}/cat_truba_vgp2.png`,
  'Труба электросварная': `${IMG_BASE}/cat_truba_esv.jpg`,
  'Труба бесшовная': `${IMG_BASE}/cat_truba_bsh2.png`,
  'Труба НКТ': `${IMG_BASE}/cat_truba_nkt.jpg`,
  'Балка двутавровая': `${IMG_BASE}/cat_balka2.png`,
  'Швеллер': `${IMG_BASE}/cat_shveller.png`,
  'Уголок равнополочный': `${IMG_BASE}/cat_ugolok_ravn.jpg`,
  'Уголок неравнополочный': `${IMG_BASE}/cat_ugolok_nerav2.png`,
  'Отвод 90°': `${IMG_BASE}/cat_otvod2.jpg`,
  'Тройник': `${IMG_BASE}/cat_troynik2.jpg`,
  'Переход': `${IMG_BASE}/cat_krestovina2.jpeg`,
  'Проволока': `${IMG_BASE}/cat_provoloka2.jpg`,
  'Сетка': `${IMG_BASE}/cat_setka2.png`,
  'Электроды': `${IMG_BASE}/cat_elektrody2.png`,
  'Крепёжные изделия': `${IMG_BASE}/cat_krepezh.png`,
};
